...
def generate_synthetic_clinical_data(
    n_cases: int = 250, output_file: str = "data/raw/TCGA-STAD_clinical.json"
):
...
def generate_synthetic_mutation_data(
    n_cases: int = 250, output_file: str = "data/raw/TCGA-STAD_mutations.csv"
):
    ...
    for case_idx in range(n_cases):
        ...
        for _mut_idx in range(n_mutations):
...
def generate_synthetic_immune_subtypes(
    n_cases: int = 250, output_file: str = "data/raw/TCGA-STAD_immune_subtypes.csv"
):
...
def generate_synthetic_msi_status(
    n_cases: int = 250, output_file: str = "data/raw/TCGA-STAD_msi_status.csv"
):
